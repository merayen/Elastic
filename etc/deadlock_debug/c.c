// This is the modified generated source that works and is modified back to generated C
/*
	...
	bool all_finished = false;
	 {
		...
		if (work_units_mutex_lock_result == 0) {
			if (work_units[1] != 0) {
				...
				all_finished = work_units[0] == 2 && work_units[3] == 2;
				if (all_finished) {
					work_units[1] = 1;
				}
			}
...
int main() {
	...
	fprintf_mutex_init_result = pthread_mutex_init(&fprintf_mutex, &mutex_attr);
