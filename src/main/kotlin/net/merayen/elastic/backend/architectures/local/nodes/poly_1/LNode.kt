...
class LNode : LocalNode(LProcessor::class.java), GroupLNode {
	...
	override fun getCurrentBeatPosition() = (parent as GroupLNode).getCurrentBeatPosition()
	override fun getCursorBeatPosition() = (parent as GroupLNode).getCursorBeatPosition()
