...
public abstract class Surface extends javax.swing.JPanel implements java.awt.event.MouseListener, java.awt.event.MouseMotionListener {
	...
	public Surface() {
		net.merayen.merasynth.ui.objects.node.Node node = new net.merayen.merasynth.ui.objects.node.Node();
		node.translation.x = 0.1f;
		node.translation.y = 0.1f;
		node.width = 0.1f;
		node.height = 0.1f;
		top_ui_object.add(node);
		top_ui_object.translation.scale_x = 2f;
		top_ui_object.translation.scale_y = 2f;
